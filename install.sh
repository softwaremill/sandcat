...
echo "     # Choose a template: liberal (allows all GET) or strict (explicit hosts only)"
echo "     cp .devcontainer/sandcat/settings.liberal.example.json ~/.config/sandcat/settings.json"
